...
//
  ...
  void SoftwareSerial::timerInit(void) {
    ...
    HardwareTimer_Handle.timer = SW_SERIAL_TIMER;
    HardwareTimer_Handle.irqHandle = SWSerial_Handler;
    TimerHandleInit(&HardwareTimer_Handle, 0, prescaler);
